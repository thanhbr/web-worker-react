      ...
      <div style={{ display: 'flex', gap: '20px', marginTop: 72 }}>
        ...
        <div>
          ...
          {asyncLoadings.map((_, index) => (
            <p key={index} style={{ color: 'purple' }}>Calculating asynchronously...</p>
          ))}
          {fibAsync.length > 0 && (
            <ul>
